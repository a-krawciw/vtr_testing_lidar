...
# Log
echo "Running localization on sequence ${LOC_INPUT}, storing result to ${VTRHRESULT}/main"
...
cp -r ${VTRHRESULT}/main ${VTRHRESULT}/${LOC_INPUT}

echo "Running localization on sequence ${LOC_INPUT}, storing result to ${VTRHRESULT}/main - DONE"
