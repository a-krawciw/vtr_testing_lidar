...
## example usage: test_planning.sh boreas-2021-09-02-11-42 boreas-2021-09-07-09-35
...
# Log
echo "Running planning on sequence ${LOC_INPUT} to reference sequence ${ODO_INPUT}, storing result to ${VTRHRESULT}/${ODO_INPUT}/${LOC_INPUT}"
